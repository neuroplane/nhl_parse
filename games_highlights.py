...
games_data = requests.get(
    "https://statsapi.web.nhl.com/api/v1/schedule?startDate=2021-03-29&endDate=2021-03-30&hydrate=team,linescore,broadcasts(all),game(content(media(epg)),seriesSummary),radioBroadcasts,metadata").json()
