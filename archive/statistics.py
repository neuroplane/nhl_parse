...
try:
    ...
    draw.text((SCW / 2, 20), ' ^= ^~   ^{ ^u ^t ^} ^x ^u  ^x ^s     ' + str(yesterday_rus) + '', font=font_upheaval,
              fill=0, anchor="mm")
    ...
    draw.text((SCW / 2, START_Y_FIELDPLAYERS), ' ^q ^~ ^| ^q ^p   ^t ^x    ', font=font_upheaval, fill=0, anchor="mm")
    ...
    draw.text((pos_name, START_Y_FIELDPLAYERS), " ^x ^|  ", font=def_font, fill=0, anchor="lm")
    draw.text((pos_team, START_Y_FIELDPLAYERS), " ^z ^~ ^|", font=def_font, fill=0, anchor="lm")
    draw.text((pos_position, START_Y_FIELDPLAYERS), " ^= ^~ ^w", font=def_font, fill=0, anchor="lm")
    draw.text((pos_goals, START_Y_FIELDPLAYERS), " ^s ^~ ^{", font=def_font, fill=0, anchor="rm")
    draw.text((pos_assists, START_Y_FIELDPLAYERS), " ^= ^p  ", font=def_font, fill=0, anchor="rm")
    draw.text((pos_points, START_Y_FIELDPLAYERS), " ^~   ^z", font=def_font, fill=0, anchor="rm")
    ...
    #################################################################################################################
    START_Y_GOALIES = START_Y_FIELDPLAYERS + 30
    draw.text((SCW / 2, START_Y_GOALIES), ' ^r   ^p   ^p   ^x', font=font_upheaval, fill=0, anchor="mm")
    ...
    draw.text((pos_name, START_Y_GOALIES), " ^x ^|  ", font=def_font, fill=0, anchor="lm")
    draw.text((pos_team, START_Y_GOALIES), " ^z ^~ ^|", font=def_font, fill=0, anchor="lm")
    draw.text((pos_saves, START_Y_GOALIES), "     ^y ^r  , %", font=def_font, fill=0, anchor="rm")
    draw.text((pos_wins, START_Y_GOALIES), " ^= ^~ ^q ^u ^t", font=def_font, fill=0, anchor="rm")
    draw.text((pos_shutouts, START_Y_GOALIES), "      ", font=def_font, fill=0, anchor="rm")
    draw.text((pos_gaa, START_Y_GOALIES), " ^z.  ^} ^p ^t ^a ^v.", font=def_font, fill=0, anchor="rm")
    ...
    draw.text((SCW / 2, START_Y_GOALIES + LINE_HEIGHT * 5), '#   ^~ ^z ^z ^u ^y ^r   ^u   ^t   ^u', font=font_machinec,
              fill=0, anchor="mm")
    ################################################################################################################
